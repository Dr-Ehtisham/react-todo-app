        ...
        <div className="row">
          <div className="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
            ...
            <form onSubmit={handleRegister}>
              ...
              <div className="row">
                <div className="col">
                  <button style={myStyle} className='register btn w-100' disabled={isProcessing}>
                  {
              ...
              <div className="row mt-4">
                <div className="col">
                  <p className='mb-0 text-center'>Already have an acount? <Link to='/authentication/login' className='text-dark'>Login</Link></p>
                </div>
              </div>
